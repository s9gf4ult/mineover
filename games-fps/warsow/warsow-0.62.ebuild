...
SRC_URI="http://www.zcdn.org/dl/warsow_0.61_unified.zip
...
src_unpack() {
	cd "${WORKDIR}"
	unpack warsow_0.61_unified.zip
	mv warsow_0.61_unified warsow_0.62_unified
	cd warsow_0.62_unified
        unpack warsow_0.62_update.zip
	cd ..
	unpack warsow_0.62_sdk.zip
}
...
#	mv -v warsow_0.61_unified warsow_0.62_unified
